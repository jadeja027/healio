...
import { FRONT_REGIONS } from '@/lib/bodyMapConfig'
...
export function FrontBodySVG({ selectedAreas, onToggle }: Props) {
  return (
    <svg viewBox="0 0 200 280" className="h-full w-full" role="img" aria-label="Front body map">
